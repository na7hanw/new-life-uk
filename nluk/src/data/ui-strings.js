...
const BASE_UI = {
  ...
  privacyBody: "This app stores only your language preference and theme setting locally on your device. No personal information is collected or shared. There are no cookies and no user accounts.",
  privacyLocal: "Stored locally on your device only:",
  privacyKeyLang: "Language preference",
  privacyKeyTheme: "Dark / light mode",
  privacyKeyTab: "Last work tab viewed",
  privacyKeyConsent: "Your crash-report consent choice",
  privacyCrashTitle: "🐛 Anonymous crash reports",
  privacyCrashBody: "With your permission, the app sends anonymous error reports to Sentry (sentry.io) when it crashes. This helps us fix bugs. No personal information is included. No session recordings are made. You can opt out at any time below.",
  privacyCrashOn: "✅ Crash reports: on",
  privacyCrashOff: "❌ Crash reports: off",
  privacyCrashEnable: "Turn on",
  privacyCrashDisable: "Turn off",
  ...
  consentBody: "To help us fix bugs faster, this app can send anonymous crash reports to Sentry (an error-monitoring service). No personal information is included. You can change this at any time in More → Privacy.",
