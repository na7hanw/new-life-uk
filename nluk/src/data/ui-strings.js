...
const BASE_UI = {
  ...
  appsTab: "Apps", savesTab: "Free Stuff", gemsTab: "Gems",
  ...
  appsTitle: "Essential Apps to Install 📲", appsSub: "Free apps every new arrival in the UK should have.",
...
const UI_OVERRIDES = {
  ...
  uk: { app: "Нове Життя UK", tag: "Безкоштовний гід для UK", sos: "SOS", close: "Закрити", back: "Назад", home: "Головна", guides: "Посібники", work: "Робота", saves: "Безкоштовно", more: "Ще", search: "Пошук…", forYou: "Для вас", quickActions: "Швидкі дії", helplines: "Лінії допомоги", jobsTab: "Робота", certsTab: "Сертифікати", careerTab: "Кар'єра", savesTitle: "Безкоштовне", gemsTitle: "Поради 💎", appsTitle: "Необхідні застосунки 📲", appsSub: "Безкоштовні застосунки для кожного, хто приїхав до Великої Британії.", theme: "Тема", language: "Мова", apply: "Подати", settings: "Налаштування", share: "Поділитися", copied: "Скопійовано!", status: { refugee: "Біженець", skilled: "Кваліфікований", family: "Сімейна", eu: "EU", student: "Студент", other: "Інше" }, openLink: "Відкрити" },
  ...
  pl: { app: "Nowe Życie UK", tag: "Bezpłatny przewodnik UK", sos: "SOS", close: "Zamknij", back: "Wstecz", home: "Start", guides: "Poradniki", work: "Praca", saves: "Za darmo", more: "Więcej", search: "Szukaj…", forYou: "Dla ciebie", quickActions: "Szybkie akcje", helplines: "Pomoc", jobsTab: "Praca", certsTab: "Certyfikaty", careerTab: "Kariera", savesTitle: "Za darmo", gemsTitle: "Wskazówki 💎", appsTitle: "Niezbędne aplikacje 📲", appsSub: "Darmowe aplikacje dla każdego nowo przybyłego do Wielkiej Brytanii.", theme: "Motyw", language: "Język", apply: "Aplikuj", settings: "Ustawienia", share: "Udostępnij", copied: "Skopiowano!", status: { refugee: "Uchodźca", skilled: "Pracownik", family: "Rodzinna", eu: "EU", student: "Student", other: "Inne" }, openLink: "Otwórz" },
  fr: { app: "Nouvelle Vie UK", tag: "Guide gratuit pour le UK", sos: "SOS", close: "Fermer", back: "Retour", home: "Accueil", guides: "Guides", work: "Travail", saves: "Gratuit", more: "Plus", search: "Chercher…", noResults: "Aucun résultat.", forYou: "Pour vous", quickActions: "Actions rapides", helplines: "Numéros utiles", jobsTab: "Emplois", certsTab: "Certificats", careerTab: "Carrière", savesTitle: "Gratuit et réductions", gemsTitle: "Astuces 💎", appsTitle: "Applications essentielles 📲", appsSub: "Applications gratuites pour toute nouvelle arrivée au Royaume-Uni.", theme: "Thème", language: "Langue", apply: "Postuler", settings: "Paramètres", share: "Partager", copied: "Copié!", status: { refugee: "Réfugié", skilled: "Qualifié", family: "Familial", eu: "EU", student: "Étudiant", other: "Autre" }, openLink: "Ouvrir" },
};
