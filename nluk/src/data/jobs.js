...
export const JOBS = [
  ...
  {
    icon: "🍴",
    content: { en: { role: "Kitchen Porter / Dishwasher", desc: "Washing up, cleaning, and basic food prep in restaurants, hotel kitchens, pubs, and staff canteens. One of the quickest entry points into hospitality — many places hire on the spot. Free Food Hygiene Level 2 certificate available via Jobcentre." } },
    pay: "£12.71–£13/hr",
  ...
  {
    icon: "☕",
    content: { en: { role: "Barista / Café Staff", desc: "Coffee shops, cafés, and quick-service restaurants. Full training provided on the job. Starbucks, Costa, Caffè Nero, and Pret hire frequently. Smart/clean appearance expected — uniform usually provided by the employer." } },
    pay: "£12.71–£13.50/hr",
  ...
  {
    icon: "🏨",
    content: { en: { role: "Hotel & Hospitality Staff", desc: "Housekeeping, reception, and food service in hotels. Housekeeping needs no experience. Reception benefits from English skills. Tips possible in many roles. Smart/neat appearance expected." } },
    pay: "£12.71–£14/hr",
    tags: ["No experience needed", "Tips possible"],
