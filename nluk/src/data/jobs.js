...
export const JOBS = [
  ...
  },
  {
    ...
    applyLinks: [
      { name: "OCS Group Jobs", url: "https://jobs.ocs.com/vacancies/vacancy-search-results.aspx" },
  ...
  },
  {
    ...
    applyLinks: [
      ...
      { name: "Securitas UK Jobs", url: "https://www.securitas.uk.com/careers/our-jobs/" },
...
export const CERTS = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Flexible Support Fund (GOV.UK)", url: "https://www.gov.uk/guidance/universal-credit-and-jobseekers-allowance-jsa-back-to-work-schemes" },
    ],
    studyLinks: [
      { name: "Food safety basics — Food Standards Agency", url: "https://www.food.gov.uk/business-guidance/managing-food-safety" },
  ...
  },
  {
    ...
    studyLinks: [
      { name: "Free CITB mock test (CITB)", url: "https://www.citb.co.uk/courses-and-qualifications/health-safety-and-environment-hse-test-and-cards/preparing-for-the-test/" },
      { name: "Which CSCS card do you need?", url: "https://www.cscs.uk.com/cards/" },
    ],
  },
  {
    icon: "🛡",
  ...
  },
  {
    ...
    studyLinks: [
      { name: "Preparing for forklift test (RTITB guide)", url: "https://www.rtitb.com/course-locator/" },
      { name: "ITSSAR approved instructors", url: "https://www.itssar.org.uk/directory/" },
    ],
  },
  {
    icon: "🚛",
  ...
  },
  {
    ...
    studyLinks: [
      ...
      { name: "Free care training resources (Skills for Care)", url: "https://www.skillsforcare.org.uk/Developing-your-workforce/Care-Certificate/Care-Certificate-standards.aspx" },
    ],
  },
  {
    icon: "🍺",
    ...
    studyLinks: [
      ...
      { name: "Licensing Act 2003 — plain English guide (GOV.UK)", url: "https://www.gov.uk/government/publications/explanatory-memorandum-revised-guidance-issued-under-s-182-of-licensing-act-2003" },
    ],
  },
  {
    icon: "🚕",
