...
const BASE_UI = {
  ...
  privacyBody: "This app stores only your language, theme, and visa status in your device's local storage. No personal data is ever collected, transmitted, or shared. No analytics. No cookies. No servers. Fully GDPR compliant.",
...
export const GUIDES = [
  ...
  { id: "bank", cat: "Money", icon: "🏦", content: { en: { title: "Opening a Bank Account", summary: "Most digital banks accept share code + face scan. No credit history needed.", steps: ["Revolut, Monzo, and Starling all accept share code + selfie/face scan. Approved in hours.", "Revolut also works with just a passport photo if your share code isn't ready.", "If digital banks decline: Barclays, NatWest, Lloyds, HSBC — ask for a 'basic bank account'.", "You do NOT need a fixed address. Hostel or charity address is fine.", "Credit unions also lend without credit history.", "⚠ Never pay anyone to open an account. Always a scam."] } }, cost: "Free", time: "Same day", bring: ["Share code or passport", "Smartphone"], links: [{ name: "Revolut", url: "https://www.revolut.com" }, { name: "Monzo", url: "https://monzo.com" }, { name: "Starling", url: "https://www.starlingbank.com" }, { name: "Basic bank account (GOV.UK)", url: "https://www.gov.uk/apply-basic-bank-account" }] },
  ...
  { id: "housing-help", cat: "Housing", icon: "🏠", content: { en: { title: "Council Housing & Homelessness Help", summary: "If homeless or at risk, your local council has a legal duty to help.", steps: ["Contact your local council housing department immediately.", "Apply for the social housing waiting list as early as possible — long waits in most cities.", "Claim UC Housing Element to help with private rent.", "Shelter helpline: 0808 800 4444 (free, Mon-Fri 8am-8pm).", "NACCOM lists refugee-specific accommodation charities across the UK."] } }, cost: "Free", time: "Apply immediately", bring: ["Share code"], links: [{ name: "Find your council (GOV.UK)", url: "https://www.gov.uk/find-local-council" }, { name: "Shelter", url: "https://www.shelter.org.uk" }, { name: "NACCOM", url: "https://naccom.org.uk" }] },
  { id: "move-on", cat: "Housing", icon: "📦", content: { en: { title: "The 56-Day Move-On Period", summary: "Just got refugee status? You have 56 days to leave asylum accommodation and set up your new life.", steps: ["When you receive your refugee decision letter, the 56-day countdown begins. You must leave your asylum accommodation within this period.", "IMMEDIATELY apply for Universal Credit — the 5-week wait starts from your application date, so every day you delay costs you.", "Open a bank account the same day (Revolut, Monzo, or Starling — share code + selfie). You need this for UC.", "Apply for your National Insurance number. You can work while waiting for it.", "Contact your local council housing team — explain you are a newly recognised refugee facing the move-on period. They have a duty to help prevent homelessness.", "Register with a GP. Download the NHS App.", "Apply for a CitizenCard (£15) if you have no passport — you'll need photo ID.", "Get a free SIM card from National Databank (40GB/month from Vodafone, free at libraries).", "Ask your Jobcentre Work Coach about Flexible Support Fund (up to £300 for deposits, travel, work clothes).", "Apply for a Budgeting Advance via UC journal (up to £812 for furniture, household items) — you're eligible after 6 months on UC.", "Free furniture: British Heart Foundation furniture stores, Freecycle.org, Facebook Marketplace 'Free' groups, local refugee charities, Emmaus communities.", "⚠ Do NOT wait until day 56 to start this process. Start everything on day 1."] } }, cost: "Free", time: "Start immediately", bring: ["Refugee decision letter", "Passport or BRP"], links: [{ name: "Apply for UC (GOV.UK)", url: "https://www.gov.uk/universal-credit/how-to-claim" }, { name: "Shelter move-on advice", url: "https://www.shelter.org.uk" }, { name: "Freecycle (free items)", url: "https://www.freecycle.org" }, { name: "British Heart Foundation shops", url: "https://www.bhf.org.uk/shop" }] },
  ...
  { id: "travel", cat: "Travel", icon: "✈️", content: { en: { title: "Travelling Abroad", summary: "How to travel now that BRPs are gone.", steps: ["Travel with your passport linked to your eVisa in UKVI. Link it BEFORE you travel.", "Since June 2025, expired BRPs are NOT accepted for travel.", "Refugees without a passport: apply for a Convention Travel Document (see CTD guide).", "⚠ Refugees: NEVER travel to your country of origin. Risk losing your status.", "EU citizens: your EU passport is still valid for EU travel."] } }, cost: "CTD £75 if needed", time: "Apply 3+ months ahead", bring: ["Passport linked to UKVI"], links: [{ name: "Travel with eVisa (GOV.UK)", url: "https://www.gov.uk/evisa/travel-with-evisa" }, { name: "Apply for travel document (GOV.UK)", url: "https://www.gov.uk/apply-home-office-travel-document" }] },
  { id: "ilr", cat: "Settle & Stay", icon: "🏅", content: { en: { title: "Indefinite Leave to Remain (ILR)", summary: "Permanent UK residence — the biggest milestone.", steps: ["Most routes require 5 years of continuous lawful residence.", "⚠ 2025 white paper proposes longer periods. Refugees may need up to 20 years. Check GOV.UK regularly.", "Pass the Life in the UK test (£50) and prove English level B1.", "Keep all payslips, P60s, tax returns, tenancy agreements for 5+ years.", "ILR = permanent residence, full work rights, full benefit access. Step before citizenship."] } }, cost: "£2,885", time: "Usually after 5 years", bring: ["Passport", "5 years of evidence"], links: [{ name: "ILR information (GOV.UK)", url: "https://www.gov.uk/indefinite-leave-to-remain" }, { name: "Life in UK test (GOV.UK)", url: "https://www.gov.uk/life-in-the-uk-test" }, { name: "English language tests (GOV.UK)", url: "https://www.gov.uk/guidance/prove-your-english-language-abilities-with-a-secure-english-language-test-selt" }] },
  { id: "safety", cat: "Community", icon: "🛡", content: { en: { title: "Staying Safe", summary: "Know your rights, avoid scams, get help.", steps: ["Modern Slavery Helpline: 0800 0121 700 — free, 24/7, anonymous.", "If someone holds your passport or controls your money — this is illegal.", "Police: 999 emergencies, 101 non-emergencies. Police generally do not share information with immigration enforcement — there is a firewall policy. You will not be deported for reporting a crime.", "Domestic Abuse: 0808 2000 247 — free, 24/7, all languages.", "⚠ Never pay unregistered 'immigration consultants'. Check the OISC register first."] } }, cost: "Free", time: "Read now", bring: [], links: [{ name: "Find immigration adviser (GOV.UK)", url: "https://www.gov.uk/find-an-immigration-adviser" }, { name: "Report modern slavery", url: "https://www.modernslaveryhelpline.org" }] },
...
export const CAREERS = [
  { icon: "🏗", content: { en: { title: "Civil Engineering", salary: "£28K–£80K+" } }, tags: ["CEng", "CSCS", "ICE"], steps: { en: ["UK ENIC degree recognition (£49). Refugees: refugee@ecctis.com.", "ICE Refugee Support — free mentoring + chartership pathway.", "CSCS Green Card via free Skills Bootcamp.", "Apply: Atkins, Arup, Mott MacDonald, Network Rail.", "CEng MICE (3–5 years) → £50K–£80K+."] }, links: [{ name: "ICE Refugee Support", url: "https://www.ice.org.uk/about-ice/what-we-do/social-mobility/refugee-support/" }, { name: "UK ENIC", url: "https://www.enic.org.uk/Qualifications/SOC/Default.aspx" }] },
  ...
  { icon: "📊", content: { en: { title: "Project Management", salary: "£30K–£75K+" } }, tags: ["APM", "Prince2", "CMI"], steps: { en: ["UK ENIC for degree recognition (£49).", "APM refugee support + mentoring.", "Chartered Manager Degree Apprenticeship = free MBA."] }, links: [{ name: "APM", url: "https://www.apm.org.uk/" }, { name: "CMI", url: "https://www.managers.org.uk/" }] },
