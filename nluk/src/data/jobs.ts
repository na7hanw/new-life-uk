...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    guideIds: ["community-interpreting", "permission-to-work"],
    applyLinks: [
  ...
  },
  {
    ...
    applyLinks: [
      ...
      { name: "NHS 111 — Bolton call centre", url: "https://www.jobs.nhs.uk/candidate/search?keywords=call+handler&l=Bolton" },
      { name: "Indeed — call centre jobs Bolton", url: "https://uk.indeed.com/jobs?q=customer+service&l=Bolton%2C+Greater+Manchester" },
...
export const CAREERS = [
  ...
  { id: "housing-officer", founderOrder: 15, icon: "🏠", content: { en: { title: "Housing Officer / Housing Support", salary: "£24K–£40K" } }, tags: ["DBS required", "Council", "Housing Assoc", "UK-wide"], steps: { en: ["**Housing officers are some of the most in-demand and accessible professional roles in the UK public sector.** Every local council and registered housing association in the UK recruits housing officers continuously — there are over 330 councils and 1,500+ housing associations, together employing more than 50,000 housing staff nationwide.", "**No construction background needed.** The role is about communication, case management, tenancy law, and problem-solving — not physical labour. Your admin and business management experience directly applies.", "**What you will do:** Manage tenancy agreements, conduct property inspections, handle rent arrears, resolve disputes between neighbours, support vulnerable tenants, coordinate repairs with contractors, maintain accurate records. Many roles are hybrid (office + site visits).", "**DBS check required** — your employer arranges and pays for this. Enhanced DBS is the standard for housing officer roles.", "**Key national employers:** L&Q (London & Quadrant), Clarion Housing, Sanctuary Group, Peabody, Riverside, Platform Housing, Notting Hill Genesis, Together Housing Group, Home Group, Mears Group (housing maintenance contracts for councils UK-wide), Serco (public housing contracts), and Pinnacle Group. Your nearest local council is always worth searching directly.", "**Salary:** Entry-level housing assistant: £24K–£28K. Housing officer: £28K–£35K. Senior housing officer / team leader: £35K–£45K. Pay is broadly consistent UK-wide — outside London the cost of living is significantly lower, making take-home pay stretch much further.", "**How to apply with no UK housing experience:** Lead with your admin, communication, and case-management skills. Many councils accept equivalent overseas professional experience. Mention any customer-facing or public service roles. A short CIH Level 2 Award in Housing (online, ~£200–£400) shows commitment and covers basic UK tenancy law.", "**CIH (Chartered Institute of Housing)** is the professional body. Level 2 and Level 3 courses are available online and directly funded by some employers. The CIH Level 3 Certificate in Housing is the standard professional qualification — many employers fund it on the job.", "**Progression:** Housing Assistant → Housing Officer → Senior Housing Officer → Housing Manager → Director of Housing. The CIH Level 4 and Level 5 qualifications unlock senior and management roles. Salary at management level: £45K–£65K.", "**JobCentre Plus / Universal Credit note:** Declaring housing officer applications is fully compliant. Housing roles are classified as standard employment and do not affect asylum support differently from any other job search activity once you have the right to work.", "**UK job boards:** Inside Housing Jobs (jobs.insidehousing.co.uk), CIH Jobs Board (jobs.cih.org), Community Housing Jobs, and Guardian Jobs Housing all carry UK-wide vacancies that update daily — covering roles from Devon to Aberdeen."] }, links: [{ name: "Inside Housing Jobs (UK-wide)", url: "https://jobs.insidehousing.co.uk/" }, { name: "CIH — housing qualifications", url: "https://www.cih.org/learning-and-development/qualifications/" }, { name: "Riverside Housing — work for us", url: "https://www.riverside.org.uk/about-us/work-for-us/" }, { name: "Mears Group — careers", url: "https://www.mearsgroup.co.uk/careers/" }, { name: "Indeed — housing officer UK", url: "https://uk.indeed.com/jobs?q=housing+officer&l=United+Kingdom" }] },
  { id: "admin-support", founderOrder: 25, icon: "💼", content: { en: { title: "Admin / Business Support", salary: "£22K–£32K" } }, tags: ["No experience needed", "Every sector", "UK-wide"], steps: { en: ["**Admin and business support roles are the entry point into almost every UK organisation** — NHS, councils, logistics, legal, education, financial services, and private business all hire continuously. No specific UK qualifications required; strong English and basic IT skills (Word, Excel, email) are enough to start.", "**Admin roles exist in every UK city, town, and region** — NHS trusts, councils, universities, logistics companies, law firms, and private businesses hire continuously. Once you have refugee status you can live and work anywhere in the UK, which means you can target any area for the best combination of salary and cost of living.", "**Most accessible entry-level roles:** Administrator, Receptionist, Data Entry Clerk, Office Assistant, Records Clerk, Scheduling Coordinator. These roles exist in hospitals, GP surgeries, councils, housing associations, logistics depots, law firms, and every other sector.", "**NHS admin** is particularly valuable — every NHS trust in the UK hires admin staff continuously for outpatient booking, ward administration, finance, and primary care. Salary: NHS Band 2 £22K–£25K, Band 3 £24K–£27K. Search jobs.nhs.uk by your location. Employment conditions are excellent (NHS pension, job security, progression).", "**Local councils** across the UK hire admin in every department — housing, planning, finance, social care, environment. These roles offer excellent job security and pension contributions. Search your local council's website or search 'council administrator' on indeed.com.", "**Building UK work history:** An admin role is one of the most effective ways to establish UK employment history, references, and a National Insurance contribution record — all of which are crucial for long-term stability and future visa/immigration applications.", "**Progression from admin:** Business Support Officer → Team Administrator → PA/EA → Office Manager → Business Manager. With an MBA background, progression to Business Manager, Operations Manager, or Business Analyst is realistic within 2–3 years of UK experience.", "**Key UK agencies (all nationwide):** Reed, Adecco, Manpower, Hays, Brook Street, and Staffline. Registering with 2–3 agencies simultaneously maximises options — they often have roles before they're publicly advertised.", "**Free IT skills upgrade:** If your Excel or Word skills need updating, Microsoft offers free training at learn.microsoft.com. This takes a few days and significantly strengthens applications for NHS and council admin roles."] }, links: [{ name: "NHS Jobs — admin UK", url: "https://www.jobs.nhs.uk/candidate/search?keywords=administrator" }, { name: "Civil Service admin jobs", url: "https://www.civilservicejobs.service.gov.uk/" }, { name: "Reed — admin jobs UK", url: "https://www.reed.co.uk/jobs/admin-jobs" }, { name: "Microsoft free Office training", url: "https://learn.microsoft.com/en-us/training/browse/?products=office" }, { name: "Indeed — admin UK", url: "https://uk.indeed.com/jobs?q=admin&l=United+Kingdom" }] },
  { id: "gas-engineer", founderOrder: 13, icon: "🔥", content: { en: { title: "Gas & Heating Engineer", salary: "£32K–£55K employed | £500–£900/day self-employed" } }, tags: ["Gas Safe", "ACS", "Skills Bootcamp", "Self-employed potential"], steps: { en: ["**One of the highest-earning trades in the UK with a structural shortage.** The UK has a target to install 600,000 heat pumps per year by 2028 and replace gas boilers across millions of homes. Gas and heating engineers are among the most in-demand tradespeople nationally — not a sector in decline.", "**Two routes in:** (1) Level 3 Gas Engineering Apprenticeship — earn while you learn (£18K–£23K during training, ~24 months); (2) Short-course career-change route — Level 3 Diploma (~£8,000–£15,000 privately, Skills Bootcamp funding may reduce costs). Search gov.uk/find-a-skills-bootcamp for funded options.", "**Qualifications required:** Level 3 Diploma in Plumbing and Domestic Heating + ACS (Approved Certification Scheme) assessments + Gas Safe registration. You cannot legally work on gas appliances in the UK without Gas Safe registration — it is the legal gateway.", "**Apprenticeship funding:** The government pays 100% of training costs for apprentices under 21 at employers with fewer than 50 staff. Apply via findapprenticeship.service.gov.uk. Major employers: British Gas (Centrica), Baxi, Vaillant, E.ON, and thousands of independent heating firms.", "**British Gas 'Skills for Life' programme** actively recruits career changers and provides an accelerated pathway into heating engineering — they sponsor training and guarantee employment on completion.", "**Salary once qualified:** Employed: £32K–£45K. Experienced: £45K–£55K. Self-employed: £500–£900/day. Emergency callouts command premium rates — some central London engineers earn £70K–£100K+ self-employed.", "**Heat pump engineers = the future.** Adding a Domestic Heat Pump Installer qualification (MCS certification, ~£1,500) after Gas Safe opens the renewable heating market. The UK Boiler Upgrade Scheme and Warm Homes Plan create government-backed demand that will run for decades.", "**Right to Work required** for all employed and apprenticeship routes. ACS assessments and registration do not require RTW."] }, links: [{ name: "Gas Safe — become registered", url: "https://www.gassaferegister.co.uk/gas-safety/become-gas-safe-registered/" }, { name: "Find a Heating Apprenticeship", url: "https://www.findapprenticeship.service.gov.uk/" }, { name: "British Gas — Skills for Life", url: "https://www.centrica.com/careers/early-careers/apprenticeships/" }, { name: "Skills Bootcamps (GOV.UK)", url: "https://www.gov.uk/guidance/find-a-skills-bootcamp" }] },
  { id: "electrician", founderOrder: 17, icon: "⚡", content: { en: { title: "Electrician (Domestic & Commercial)", salary: "£28K–£45K employed | £400–£700/day self-employed" } }, tags: ["JIB Gold Card", "Level 3 NVQ", "ECS Card", "AM2", "Skills Bootcamp"], steps: { en: ["**Electricians face one of the most severe UK-wide shortages.** With millions of homes needing EV charger installations, solar panel wiring, and smart home retrofits, the JIB estimates a 35,000-shortfall by 2030. This is a trade with decades of guaranteed demand built in.", "**The standard route:** Level 3 Diploma in Electrical Installations (City & Guilds 2365 or EAL equivalent) + AM2 end-point assessment + JIB Gold Card (career standard) + ECS card for site access. Full apprenticeship: 3–4 years, earning throughout.", "**Faster routes for career changers:** Intensive 12–18 month courses leading to 18th Edition Wiring Regulations (BS 7671) and Part P domestic competence scheme. Not as comprehensive as a full apprenticeship but gives quicker access to domestic electrical work and self-employment.", "**Apprenticeship funding:** Government funds 100% of training costs for under-21s at employers with under 50 staff. Pay: £15K rising to £22K through 4 stages. Apply via findapprenticeship.service.gov.uk. Employers: Wates, Balfour Beatty, Morrison Utility Services, Amey.", "**EV charger installation** is the fastest-growing niche — OZEV Tier 2 installer certification opens a premium market. Domestic EV charger installs: £600–£1,000 each. Experienced electricians complete 3–5 installs per day.", "**Solar PV installation:** MCS certification enables solar panel installation work. With the UK's solar rollout targets, MCS-registered electricians are in enormous demand — and the work is clean, outdoor, and relatively high-paying.", "**Self-employed income:** Qualified electrician day rates: £350–£700 outside London; £500–£900 in London and Southeast. Emergency callout rates are higher. Many electricians transition to full self-employment within 2–3 years of qualifying.", "**Salary progression:** Apprentice £15K–£22K → Newly qualified £28K–£32K → Experienced £35K–£45K → Self-employed specialist (EV/solar) £55K–£80K+."] }, links: [{ name: "JIB (Joint Industry Board)", url: "https://www.jib.org.uk/" }, { name: "City & Guilds Electrical Installations", url: "https://www.cityandguilds.com/qualifications-and-apprenticeships/building-and-construction/building-services-engineering/2365-diploma-in-electrical-installations" }, { name: "ECS Card — Electrotechnical Certification", url: "https://www.ecscard.org.uk/" }, { name: "Find an Electrical Apprenticeship", url: "https://www.findapprenticeship.service.gov.uk/" }] },
  { id: "train-driver", founderOrder: 27, icon: "🚄", content: { en: { title: "Train Driver — TOC-Trained", salary: "£26K training | £51K year 1 qualified | £60K–£76K experienced" } }, tags: ["No degree needed", "TOC-funded", "ASLEF union", "Psychometric tests"], steps: { en: ["**Train driving is one of the highest-paying non-degree jobs in the UK.** Qualified drivers average £55K–£65K; intercity and London routes pay up to £76K. Train Operating Companies (TOCs) recruit with zero experience and pay you throughout the 12–18 month training period.", "**No qualifications required.** TOCs train drivers completely from scratch. They look for: sustained concentration and vigilance, rule-following mindset, ability to handle isolation, good reaction times, good eyesight (correctable is fine), and a clean background.", "**The process:** Application → Psychometric tests (abstract reasoning, fault detection, attention tracking) → Situational judgement → Medical and eyesight → Interview → Paid training (12–18 months at ~£26K) → Qualified driver at full salary.", "**Northern England TOCs:** Northern Trains (UK's largest TOC by stations), Avanti West Coast, TransPennine Express, East Midlands Railway. These all recruit regularly and serve the North and Midlands. Also search: GTR, c2c, Greater Anglia, Chiltern Railways, SWR.", "**Salary from day 1 qualified:** Year 1: £50K–£55K at most TOCs. After 2 years: £55K–£65K. Intercity and London-based routes: up to £76K. Freight train drivers (DB Cargo, GB Railfreight, Freightliner) often have an easier recruitment process and earn £42K–£55K.", "**ASLEF (train driver union):** virtually all UK train drivers are members. Union membership provides legal protection, additional paid training rights, and strong collective bargaining — UK train driver salaries are among the best in Europe because of ASLEF.", "**How to maximise your chances:** Practise psychometric tests for 4–8 weeks before applying. Free and paid practice tests at jobtestprep.co.uk. The tests — abstract reasoning, fault detection, attention checking — use the same formats across most TOCs. Apply to multiple TOCs simultaneously since recruitment cycles vary.", "**Realistic timeline:** Application to first qualified shift: 18–24 months total. Well worth it for £55K+ baseline salary with strong union protection."] }, links: [{ name: "National Careers — Train Driver", url: "https://nationalcareers.service.gov.uk/job-profiles/train-driver" }, { name: "Northern Trains — careers", url: "https://www.northernrailway.co.uk/careers" }, { name: "Avanti West Coast — careers", url: "https://www.avantiwestcoast.co.uk/careers" }, { name: "ASLEF — train drivers' union", url: "https://www.aslef.org.uk/" }] },
  { id: "taxi-phv", founderOrder: 32, icon: "🚕", content: { en: { title: "Taxi / Private Hire Driver (PHV)", salary: "£22K–£40K | fully self-employed" } }, tags: ["Quick start", "Self-employed", "PHV licence", "Uber / Ola / Bolt"], steps: { en: ["**One of the fastest legal income routes after receiving refugee status.** PHV (Private Hire Vehicle) drivers can be licensed and earning within 8–16 weeks of application. No formal qualifications — just a PHV licence, Group 2 medical, and DBS check.", "**Process to start:** (1) Apply for a PHV driver's licence at your local council; (2) Pass a basic English assessment (most councils require conversational English); (3) Group 2 medical — approx £50–£100; (4) Enhanced DBS — council arranges; (5) Topographical knowledge test if required; (6) Once licensed, sign up with Uber, Ola, or Bolt within days.", "**Uber, Ola, and Bolt** operate across most UK cities and are the fastest way to start earning. Uber's onboarding is simple: upload your PHV licence online, pass their background check, and start accepting trips within days of approval.", "**Income:** New PHV driver in a mid-sized UK city: £22K–£28K full-time. London PHV: £28K–£40K (higher fares, more competition). Working nights/weekends and airport runs increases income significantly. Some drivers earn £45K+ with long hours.", "**Vehicle:** Your own car (PCO/council standard required) or rent via a hire scheme. Uber, Ola, and Splyt offer vehicle rental for drivers — typically £150–£250/week. Once established, buying your own vehicle reduces costs significantly.", "**Total cost to get licensed:** PHV application £50–£150 (varies by council). Medical: £50–£100. DBS: ~£40. Topographical test: varies. Total: approximately £200–£400. Most councils allow payment in stages.", "**Fully self-employed** — register with HMRC for free (20 minutes online), file a simple self-assessment tax return annually. Set your own hours, work around other commitments, scale up or down freely.", "**Income maximisation:** Peak hours (morning/evening commute), Friday/Saturday nights, and airport transfers generate the highest fares. Positioning near transport hubs and event venues during peak times significantly increases hourly earnings.", "**Right to Work required** — digital share code must be shown to council and app platforms."] }, links: [{ name: "GOV.UK — taxi and private hire licensing", url: "https://www.gov.uk/taxi-driver-licence" }, { name: "Uber — become a driver UK", url: "https://www.uber.com/gb/en/drive/" }, { name: "Ola UK — drive with Ola", url: "https://driver.olacabs.com/uk" }, { name: "Bolt — become a driver UK", url: "https://bolt.eu/en-gb/driver/" }] },
  { id: "customer-service", founderOrder: 35, icon: "📞", content: { en: { title: "Customer Service / Contact Centre", salary: "£22K–£30K" } }, tags: ["No experience needed", "UK-wide", "Remote options", "Shift work"], steps: { en: ["**Customer service roles are available UK-wide and increasingly fully remote.** Financial services, utilities, telecoms, retail, and NHS all have large contact centre operations. Many companies — Sky, BT, HSBC, Amazon — have transitioned to predominantly home-working models, removing location as a barrier entirely.", "**Top UK contact centre employers:** Sky, BT, HSBC, Barclays, Royal Mail, Amazon, Vodafone, The Co-operative Group, and NHS 111 all have large customer service teams and recruit year-round. Sky and BT in particular have strong internal progression tracks — many team leaders and operations managers started on the phones.", "**No qualifications needed** — employers look for clear spoken English, problem-solving ability, empathy, and reliability. Your multilingual background (Amharic, English) can be an advantage, particularly for services that need non-English speaking advisors.", "**NHS 111 call handlers** are paid NHS Band 2–3 (£22K–£26K) and are based across England. The NHS fully trains you — no clinical background required. Night and weekend shifts attract significant premiums. Apply via jobs.nhs.uk.", "**Shift premiums:** evening, weekend, and bank holiday shifts typically add 15–25% to the base hourly rate. A full-time role with regular evening/weekend shifts can net £26K–£32K effective pay.", "**How to apply:** register with Manpower, Adecco, Reed, and Brook Street (all UK-wide) — they supply temp and permanent staff to contact centres nationwide. Apply directly via employer websites and NHS Jobs. Most contact centres have rolling recruitment with fast starts (1–2 weeks).", "**Progression paths in customer service:** Advisor → Senior Advisor → Team Leader → Operations Manager. Team leader roles typically pay £28K–£35K. Operations manager: £40K–£55K. Your MBA background makes progression to operations management realistic within 2–3 years.", "**Flexible working:** many contact centres now offer hybrid (some from home) or entirely remote roles — particularly relevant while you are building UK transport familiarity in a new area."] }, links: [{ name: "NHS 111 — call handler jobs UK", url: "https://www.jobs.nhs.uk/candidate/search?keywords=call+handler" }, { name: "Sky — customer service careers", url: "https://careers.sky.com" }, { name: "The Co-op — customer service jobs", url: "https://jobs.coop.co.uk" }, { name: "Indeed — customer service UK", url: "https://uk.indeed.com/jobs?q=customer+service&l=United+Kingdom" }, { name: "Manpower UK — register", url: "https://www.manpower.co.uk" }] },
];
...
const CAREER_IDS = [
  ...
  'gas-engineer', 'electrician', 'train-driver', 'taxi-phv',
  'housing-officer', 'admin-support', 'customer-service',
]
