...
export const JOBS: Job[] = [
  ...
  {
    icon: "🏠",
    content: { en: { role: "Housing Support / Admin Officer", desc: "Work in housing services for councils, housing associations, or contractors like Serco and Mears. Roles include housing officer, housing support worker, lettings admin, and repairs coordinator. Bolton Metropolitan Borough Council, Wigan Council, and providers like Riverside Housing and Regenda regularly recruit — Greater Manchester has a very active social housing sector. Strong communication skills and a DBS check are the main requirements. Admin background is a significant advantage." } },
    pay: "£23K–£35K/yr",
...
export const CAREERS = [
  ...
  { id: "housing-officer", founderOrder: 15, icon: "🏠", content: { en: { title: "Housing Officer / Housing Support", salary: "£24K–£40K" } }, tags: ["DBS required", "Council", "Serco", "Mears", "Bolton / GM"], steps: { en: ["**Housing officers are some of the most in-demand and accessible professional roles in the UK public sector.** Bolton Metropolitan Borough Council, Wigan Council, Salford City Council, and Manchester City Council all recruit continuously. Housing associations — Riverside, Regenda, Bolton at Home, Wigan and Leigh Housing — are also major employers across Greater Manchester.", "**No construction background needed.** The role is about communication, case management, tenancy law, and problem-solving — not physical labour. Your admin and business management experience directly applies.", "**What you will do:** Manage tenancy agreements, conduct property inspections, handle rent arrears, resolve disputes between neighbours, support vulnerable tenants, coordinate repairs with contractors, maintain accurate records. Many roles are hybrid (office + site visits).", "**DBS check required** — your employer arranges and pays for this. Enhanced DBS is the standard for housing officer roles.", "**Key employers in Greater Manchester:** Bolton at Home (registered provider, based in Bolton), Wigan and Leigh Housing, Regenda Group (Northwest specialist), Riverside Housing, Mears Group (housing maintenance and management services for councils), Serco (manages housing services for government bodies), Together Housing Group.", "**Salary:** Entry-level housing assistant: £24K–£28K. Housing officer: £28K–£35K. Senior housing officer / team leader: £35K–£45K. Greater Manchester pay is comparable to the national average and significantly lower cost of living than London.", "**How to apply with no UK housing experience:** Lead with your admin, communication, and case-management skills. Many councils accept equivalent overseas professional experience. Mention any customer-facing or public service roles. A short CIH Level 2 Award in Housing (online, ~£200–£400) shows commitment and covers basic UK tenancy law.", "**CIH (Chartered Institute of Housing)** is the professional body. Level 2 and Level 3 courses are available online and directly funded by some employers. The CIH Level 3 Certificate in Housing is the standard professional qualification — many employers fund it on the job.", "**Progression:** Housing Assistant → Housing Officer → Senior Housing Officer → Housing Manager → Director of Housing. The CIH Level 4 and Level 5 qualifications unlock senior and management roles. Salary at management level: £45K–£65K.", "**JobCentre Plus / Universal Credit note:** Declaring housing officer applications is fully compliant. Housing roles are classified as standard employment and do not affect asylum support differently from any other job search activity once you have the right to work.", "**Local travel:** Westhoughton (BL5) to Bolton Centre is approximately 20 minutes by bus (route 522/524). Bolton to Manchester Piccadilly is 30 minutes by train. This opens the full Greater Manchester housing employer base."] }, links: [{ name: "Bolton at Home — careers", url: "https://www.boltonathome.org.uk/about-us/careers" }, { name: "Bolton Council — vacancies", url: "https://www.bolton.gov.uk/jobs" }, { name: "CIH — housing qualifications", url: "https://www.cih.org/learning-and-development/qualifications/" }, { name: "Riverside Housing — work for us", url: "https://www.riverside.org.uk/about-us/work-for-us/" }, { name: "Mears Group — careers", url: "https://www.mearsgroup.co.uk/careers/" }, { name: "Indeed — housing officer GM", url: "https://uk.indeed.com/jobs?q=housing+officer&l=Greater+Manchester" }] },
  { id: "admin-support", founderOrder: 25, icon: "💼", content: { en: { title: "Admin / Business Support", salary: "£22K–£32K" } }, tags: ["No experience needed", "Every sector", "Bolton / Manchester"], steps: { en: ["**Admin and business support roles are the entry point into almost every UK organisation** — NHS, councils, logistics, legal, education, financial services, and private business all hire continuously. No specific UK qualifications required; strong English and basic IT skills (Word, Excel, email) are enough to start.", "**Greater Manchester is a major employment hub.** Westhoughton (BL5 3SB) sits between Bolton and Wigan, with direct bus routes to Bolton and train access to Manchester Piccadilly (35–45 mins). This puts you within reach of one of the UK's largest and most diverse job markets outside London.", "**Most accessible entry-level roles:** Administrator, Receptionist, Data Entry Clerk, Office Assistant, Records Clerk, Scheduling Coordinator. These roles exist in hospitals, GP surgeries, councils, housing associations, logistics depots, law firms, and every other sector.", "**NHS admin** is particularly valuable: Bolton NHS Foundation Trust (Royal Bolton Hospital, BL4 0JR — 15 mins from BL5) hires admin staff continuously for outpatient booking, ward administration, and primary care. Salary: £22K–£28K Band 2–3. Employment conditions are excellent (NHS pension, job security, progression).", "**Bolton Council** admin roles include customer service advisors (contact centre), housing admin, planning admin, finance support, and social care admin — all accessed through the Bolton Council jobs portal.", "**Building UK work history:** An admin role is one of the most effective ways to establish UK employment history, references, and a National Insurance contribution record — all of which are crucial for long-term stability and future visa/immigration applications.", "**Progression from admin:** Business Support Officer → Team Administrator → PA/EA → Office Manager → Business Manager. With an MBA background, progression to Business Manager, Operations Manager, or Business Analyst is realistic within 2–3 years of UK experience.", "**Key agencies in Bolton:** Reed (Bolton branch), Adecco (Bolton), Manpower (Bolton), Hays (Manchester). Registering with 2–3 agencies simultaneously maximises temporary and permanent role options.", "**Free IT skills upgrade:** If your Excel or Word skills need updating, Microsoft offers free training at learn.microsoft.com. This takes a few days and significantly strengthens applications for NHS and council admin roles."] }, links: [{ name: "Bolton NHS Foundation Trust Jobs", url: "https://www.jobs.nhs.uk/candidate/search?keywords=admin&radius=10&location=Bolton" }, { name: "Bolton Council — jobs", url: "https://www.bolton.gov.uk/jobs" }, { name: "Reed Bolton — admin jobs", url: "https://www.reed.co.uk/jobs/admin-jobs/in-bolton" }, { name: "Microsoft free Office training", url: "https://learn.microsoft.com/en-us/training/browse/?products=office" }, { name: "Indeed admin — BL5 / Westhoughton", url: "https://uk.indeed.com/jobs?q=admin&l=Westhoughton" }] },
  { id: "customer-service", founderOrder: 35, icon: "📞", content: { en: { title: "Customer Service / Contact Centre", salary: "£22K–£30K" } }, tags: ["No experience needed", "Bolton / Wigan area", "Shift work"], steps: { en: ["**Greater Manchester is one of the UK's largest contact centre markets.** AO.com (headquartered in Bolton), The Co-operative Group, Vodafone, NHS 111, and hundreds of other organisations run large customer service operations within commuting distance of Westhoughton.", "**AO.com** (based in Great Lever, Bolton — BL3) is one of the UK's largest online electricals retailers and one of Bolton's biggest employers. They hire customer service advisors regularly, offer strong training, and have a reputation for promoting internally. Salary: £23K–£26K. A 15-minute bus ride from Westhoughton.", "**No qualifications needed** — employers look for clear spoken English, problem-solving ability, empathy, and reliability. Your multilingual background (Amharic, English) can be an advantage, particularly for services that need non-English speaking advisors.", "**NHS 111 call handlers** in Bolton are paid NHS Band 2–3 (£22K–£26K), fully trained by the NHS, and work shifts including nights and weekends (which attract higher pay). No clinical background required — this is a communication and triage role.", "**Shift premiums:** evening, weekend, and bank holiday shifts typically add 15–25% to the base hourly rate. A full-time role with regular evening/weekend shifts can net £26K–£32K effective pay.", "**How to apply:** register with Manpower, Adecco, and Brook Street in Bolton — they supply temp and permanent staff to most major contact centres. Also apply directly through AO.com, NHS jobs, and indeed. Most contact centres have rolling recruitment and can start within 1–2 weeks.", "**Progression paths in customer service:** Advisor → Senior Advisor → Team Leader → Operations Manager. Team leader roles typically pay £28K–£35K. Operations manager: £40K–£55K. Your MBA background makes progression to operations management realistic within 2–3 years.", "**Flexible working:** many contact centres now offer hybrid (some from home) or entirely remote roles — particularly relevant while you are building UK transport familiarity in a new area."] }, links: [{ name: "AO.com Careers (Bolton HQ)", url: "https://careers.ao.com" }, { name: "NHS 111 call handler jobs — Bolton", url: "https://www.jobs.nhs.uk/candidate/search?keywords=call+handler&radius=10&location=Bolton" }, { name: "The Co-op — customer service jobs", url: "https://jobs.coop.co.uk" }, { name: "Indeed customer service — Bolton", url: "https://uk.indeed.com/jobs?q=customer+service&l=Bolton%2C+Greater+Manchester" }, { name: "Manpower Bolton — temp & perm", url: "https://www.manpower.co.uk" }] },
];
...
export const CAREER_SOURCE_URL: Record<string, string> = {
  ...
  'admin-support':        'https://www.bolton.gov.uk/jobs',
  'customer-service':     'https://careers.ao.com',
}