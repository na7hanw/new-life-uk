...
export const CAREERS = [
  ...
  { id: "technology-digital", icon: "💻", content: { en: { title: "Technology & Digital", salary: "£28K–£90K+" } }, tags: ["Google", "AWS", "Coding"], steps: { en: ["Google Career Certificates (free): IT, Data, Cyber, UX.", "AWS/Azure via Skills Bootcamp.", "Code Your Future: free coding programme for refugees.", "Degree Apprenticeships — earn £20K+ while qualifying."] }, links: [{ name: "Google Certificates", url: "https://grow.google/certificates/" }, { name: "Code Your Future", url: "https://codeyourfuture.io/" }, { name: "Skills Bootcamps (GOV.UK)", url: "https://www.gov.uk/guidance/find-a-skills-bootcamp" }] },
  { id: "finance-accountancy", icon: "💷", content: { en: { title: "Finance & Accountancy", salary: "£25K–£70K+" } }, tags: ["ACCA", "CIMA", "AAT"], steps: { en: ["ACCA refugee bursary — covers first exam fees.", "AAT Level 2 free if earning under £25,734.", "Bank of England, KPMG, Deloitte refugee programmes."] }, links: [{ name: "ACCA", url: "https://www.accaglobal.com/" }, { name: "AAT", url: "https://www.aat.org.uk/" }] },
