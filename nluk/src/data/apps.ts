...
export const APPS: SaveItem[] = [
  ...
  // ─── Health ───────────────────────────────────────────────────
  {
    ...
    url: "https://www.nhs.uk/tests-and-treatments/talking-therapies/",
    guideId: "mental",
  },
  // ─── Community ────────────────────────────────────────────────
  {
...
export const APP_SOURCE_URL: Record<string, string> = {
  ...
  'Companies House — Register & File':       'https://www.gov.uk/limited-company-formation',
  'National Careers Service':               'https://nationalcareers.service.gov.uk',
  'Free Courses for Jobs — GOV.UK':         'https://www.gov.uk/guidance/free-courses-for-jobs',
  'Skills Bootcamps — GOV.UK':              'https://www.skillsforcareers.education.gov.uk/pages/training-choice/skills-bootcamp',
  'Register as Self-Employed — HMRC':       'https://www.gov.uk/become-sole-trader',
  'Companies House — Register a Company':   'https://www.gov.uk/limited-company-formation',
