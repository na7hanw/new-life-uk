...
const UI_OVERRIDES = {
  ...
  uk: { app: "Нове Життя UK", tag: "Безкоштовний гід для UK", sos: "SOS", close: "Закрити", back: "Назад", home: "Головна", guides: "Посібники", work: "Робота", saves: "Безкоштовно", more: "Ще", search: "Пошук…", forYou: "Для вас", quickActions: "Швидкі дії", helplines: "Лінії допомоги", jobsTab: "Робота", certsTab: "Сертифікати", careerTab: "Кар'єра", savesTitle: "Безкоштовне", gemsTitle: "Поради 💎", theme: "Тема", language: "Мова", apply: "Подати", settings: "Налаштування", share: "Поділитися", copied: "Скопійовано!", openLink: "Відкрити" },
  ro: { app: "Viață Nouă UK", tag: "Ghid gratuit pentru UK", sos: "SOS", close: "Închide", back: "Înapoi", home: "Acasă", guides: "Ghiduri", work: "Muncă", saves: "Gratuit", more: "Mai mult", search: "Caută…", forYou: "Pentru tine", quickActions: "Acțiuni rapide", helplines: "Linii ajutor", jobsTab: "Slujbe", certsTab: "Certificate", careerTab: "Carieră", savesTitle: "Gratuit", gemsTitle: "Sfaturi 💎", theme: "Temă", language: "Limba", apply: "Aplică", settings: "Setări", share: "Distribuie", openLink: "Deschide" },
  pl: { app: "Nowe Życie UK", tag: "Bezpłatny przewodnik UK", sos: "SOS", close: "Zamknij", back: "Wstecz", home: "Start", guides: "Poradniki", work: "Praca", saves: "Za darmo", more: "Więcej", search: "Szukaj…", forYou: "Dla ciebie", quickActions: "Szybkie akcje", helplines: "Pomoc", jobsTab: "Praca", certsTab: "Certyfikaty", careerTab: "Kariera", savesTitle: "Za darmo", gemsTitle: "Wskazówki 💎", theme: "Motyw", language: "Język", apply: "Aplikuj", settings: "Ustawienia", share: "Udostępnij", copied: "Skopiowano!", openLink: "Otwórz" },
  fr: { app: "Nouvelle Vie UK", tag: "Guide gratuit pour le UK", sos: "SOS", close: "Fermer", back: "Retour", home: "Accueil", guides: "Guides", work: "Travail", saves: "Gratuit", more: "Plus", search: "Chercher…", noResults: "Aucun résultat.", forYou: "Pour vous", quickActions: "Actions rapides", helplines: "Numéros utiles", jobsTab: "Emplois", certsTab: "Certificats", careerTab: "Carrière", savesTitle: "Gratuit et réductions", gemsTitle: "Astuces 💎", theme: "Thème", language: "Langue", apply: "Postuler", settings: "Paramètres", share: "Partager", copied: "Copié!", openLink: "Ouvrir" },
};
