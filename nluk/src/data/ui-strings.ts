...
export const TIPS = {
  ...
  refugee: ["Register with a GP — no address or ID needed.", "Request a UC Advance on day one.", "Revolut, Monzo, Starling: open with share code + selfie.", "Download the NHS App for GP bookings.", "Move-on period is 42 days from your decision notification.", "Apply for a CitizenCard (£18) — photo ID accepted everywhere.", "National Databank: free SIM with 40GB/month from Vodafone.", "ESOL classes free if you receive UC."],
