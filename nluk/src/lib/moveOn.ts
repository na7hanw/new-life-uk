...
export const MOVE_ON_ACTIONS: MoveOnAction[] = [
  {
    ...
    detail:
      'Claim on the day the grant letter arrives. You do NOT need your National Insurance number, your eVisa or a bank account to MAKE the claim — GOV.UK says plainly \'You do not need a NI number for your benefits claim to be made\', you just tell DWP at the start that you do not have one. And you can prove who you are without the eVisa: your ARC card and the Home Office decision letter are an accepted pair, though they must be shown together and with two supporting documents. The five-week wait starts the day you claim, so waiting for paperwork costs you money for nothing. Ask for an Advance in the same session — but see the next step, because the Advance is the one part of this that can be refused.',
    guideId: 'uc',
  },
  {
    id: 'ni',
