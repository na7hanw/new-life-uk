...
function ShareBar({ title, ui }: ShareBarProps) {
  ...
  return (
    <div className={styles.shareBar}>
      ...
      <button className={`${styles.shareIcon} ${styles.copy}`} onClick={() => share('copy')} aria-label={copied ? (ui.copied || 'Copied!') : (ui.shareCopy || 'Copy link')} title={copied ? (ui.copied || 'Copied!') : (ui.shareCopy || 'Copy link')}>
        {copied ? (
